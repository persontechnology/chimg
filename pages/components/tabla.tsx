...
function Table({ columns, data }) {
  ...
  return (
    <div className="card">
        ...
        <div className="card-footer bg-white d-sm-flex justify-content-sm-between align-items-sm-center py-sm-2">
          
          <ul className="pagination pagination-flat justify-content-around">
          ...
          <span>Un total de {data.length} registros {' '}</span>
          <span>
            pagína{' '}
            <strong>
          ...
          <div className="pagination pagination-flat justify-content-around mt-3 mt-sm-0">
